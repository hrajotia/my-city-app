...
const NotFound = () => (
  <div className='not-found'>
    ...
    <div className='message-box'>
      <h1><FormattedMessage id='app.not_found.404' /></h1>
      <p><FormattedMessage id='app.not_found.text' /></p>
      <div className='buttons-con'>
        <div className='action-link-wrap'>
          <Link className='link-button' to='/'><FormattedMessage id='app.not_found.go_to_home' /></Link>
        </div>
      </div>
    </div>
  </div>
